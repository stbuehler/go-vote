...
func (_ handler) ServeHTTP(w http.ResponseWriter, req *http.Request) {
	switch req.URL.Path {
	case "/Sortable-1.4.2.min.js":
		w.Header().Add("Content-Type", "application/javascript")
		w.Write(sortable_min_js)
	case "/vote-0.1.css":
...
var sortable_min_js = []byte(`/*! Sortable 1.4.2 - MIT | git://github.com/rubaxa/Sortable.git */
...
var vote_html = []byte(`<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <title>Vote</title>

  <script src="Sortable-1.4.2.min.js"></script>
  <script src="vote-0.1.js"></script>
  <link rel="stylesheet" href="vote-0.1.css">
</head>
<body>
...
var vote_js = []byte(`function Vote(node, choices, initialSelection) {
  var self = this;
  this.node = node;
...
Vote.prototype.submit = function(baseURL, elId, voter, onfinished) {
  var xhr = new XMLHttpRequest();
  xhr.open('POST', baseURL + "e/vote/" + elId, true);
